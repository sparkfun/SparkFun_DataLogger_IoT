...
/*
  ...
  This code is written for the DataLogger IoT (DEV-20594)
  ...
  ** Please note: this example will only work on u-blox ADR or High Precision GNSS or Time Sync products **
  ...
  DataLogger IoT: https://www.sparkfun.com/products/20594
...
void setup()
{
  ...
  Serial.println(F("SparkFun DataLogger IoT GNSS Logging : SPI and SDIO"));
